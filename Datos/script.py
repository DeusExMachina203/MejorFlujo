...
#mapGenConsecion = genConsecion.explore(m = mapCentralesTransmision, color = 'purple')
mapRerExistentes = rerExistentes.explore(m = mapCentralesTransmision , color = 'orange')
